...
import { HttpCountriesResponse, HttpGlobalResponse, HttpCountryResponse } from './api.interface';
...
export class ApiService {
  ...
  getCountryStats(code: string): Observable<CountryStatus> {
    return this.httpClient.get<HttpCountryResponse>(`${this.ROUTES.countries}/${code}`).pipe(map(res => {
      return new CountryStatus(res.data);
    }))
  }
